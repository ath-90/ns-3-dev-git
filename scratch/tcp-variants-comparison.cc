...
int main (int argc, char *argv[])
{
  ...
  double error_p = 0.0;
  std::string bandwidth = "128Kbps";
  std::string delay = "0.01ms";
  std::string access_bandwidth = "128Kbps";
  std::string access_delay = "45ms";
  bool tracing = true;
  std::string prefix_file_name = "TcpVariantsComparison";
  uint64_t data_mbytes = 30;
  ...
  CommandLine cmd;
  cmd.AddValue ("transport_prot", "Transport protocol to use: TcpReno, TcpNewReno, "
